#' Compute the Relative Component Value at Risk of a Portfolio
#'
#' Using the Asset Normal Approach, the function computes the Relative Component Value at Risk of a portfolio for a given time series of returns and a vector of monetary positions.
...
#'
#' @param return a class "xts" element: time serie of returns. In order to get it, it is recommended to use \code{\link[CVCBasicVaR:Return_Download]{Return_Download}} function
...
#'
#' @return The function returns a class "matrix" object containing the Relative Component VaR of every asset of the portfolio for its pre-specified monetary exposure.
...
#' RelativeComponentVaR <- Portfolio_Relative_Component_VaR(Returns, 0.99, Wealth, 10)
#' ## End (Not run)
#'
#' @export
Portfolio_Relative_Component_VaR <- function (return, confidence_level, wealth, T) {
