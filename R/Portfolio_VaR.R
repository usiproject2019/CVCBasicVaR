#' Compute the Value at Risk for a Portfolio
#'
...
#'
#' @return The function returns a class "matrix" object containing the VaR of the portfolio for the pre-specified monetary exposure.
...
#' PortfolioVaR <- Portfolio_VaR(Returns, 0.99, Wealth, 10)
#' ## End (Not run)
#' @export
